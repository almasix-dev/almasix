...
:::note
Almasix’s application layout will feel familiar if you have used other
structured PHP or Node frameworks — but you do not need that background.
Public APIs, the CLI, the ORM, and the view engine are Almasix’s own:
**Smith**, **Articulate**, and **Prism**.
:::
...
Installing only the framework (`pip install almasix` / `pipx install almasix`)
