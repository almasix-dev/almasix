...
| **M22–M48** | Roadmap on `/progress`; see `docs/PLAN.md` |

## Growing with Almasix

M0–M21, M30, M31, M40, M41, M49, and M50 are closed; **M5** is partly done.
Next is **M22 — Concurrency**. The board on `/progress`
