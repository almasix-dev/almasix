...
| **M29, M36, M47–M48, M52** | Roadmap on `/progress`; see `docs/PLAN.md` |

## Growing with Almasix

M0–M28, M30–M35, M38–M46, M49–M51, M53 are closed on the ladder. M32–M35
...
language support (**M45**) and the language server (**M46**) are closed; next
autopilot is **M47** (VS Code + JetBrains) → **M52** (Sonar). No pauses;
M36 / M48 later.
The board on
