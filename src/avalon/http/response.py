...
class Redirect(RedirectResponse):
    ...
    def with_input(self, values: Mapping[str, Any] | None = None) -> Redirect:
        ...
        if values is None:
            from avalon.http.request import get_request
...
def back(
    ...
    *,
    ...
    Avalon reads the ``Referer`` header rather than a session-stored previous
...
class ResponseFactory:
    ...
    def view(
        ...
        *,
        ...
        from avalon.caliburn.helpers import view
