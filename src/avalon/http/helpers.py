...
from avalon.http.request import Request, get_request
from avalon.http.response import ResponseFactory, make_response
...
def response(
    ...
    *,
    ...
    ``response()`` hands back a :class:`~avalon.http.response.ResponseFactory`
