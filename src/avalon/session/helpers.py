...
from avalon.session.store import Session, get_session

if TYPE_CHECKING:
    from avalon.auth.cookies import QueuedCookie
...
class CookieJar:
    ...
    def queue(
        ...
        **kwargs: Any,
        ...
        from avalon.auth.cookies import QueuedCookie, queue_cookie
    ...
    def forget(self, name: str, *, path: str = "/") -> None:
        ...
        from avalon.auth.cookies import queue_forget_cookie
