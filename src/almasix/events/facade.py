"""Static ``Event`` façade over :class:`~almasix.events.dispatcher.Dispatcher`."""
...
from almasix.events.dispatcher import Dispatcher, Listener
...
class Event:
    ...
    def get_dispatcher(cls) -> Dispatcher:
        if cls._dispatcher is None:
            from almasix.events.helpers import resolve_dispatcher
