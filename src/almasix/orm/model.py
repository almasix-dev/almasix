...
from almasix.orm.inflector import foreign_key, snake, table_name
...
# Set by ``almasix.orm.seeder.without_model_events`` / ``WithoutModelEvents``.
...
class RelationNotLoadedError(AttributeError):
    ...
    By default, Almasix never lazy-loads on attribute access: a hidden query
...
class Model(metaclass=ModelMeta):
    ...
    def should_be_strict(cls, value: bool = True) -> None:
        ...
        Lazy loading is already strict in Almasix — unloaded relation access
    ...
    async def load_morph(self, relation: str, spec: Mapping[Any, Any]) -> Model:
        ...
        from almasix.orm.eager import load_morph
    ...
    async def load_morph_count(self, relation: str, spec: Mapping[Any, Any]) -> Model:
        ...
        from almasix.orm.eager import load_morph_aggregate
    ...
    async def load_aggregate(
        ...
        **constrained: Any,
        ...
        from almasix.orm.eager import load_aggregates
    ...
    def belongs_to_many(
        ...
        from almasix.orm.relations import BelongsToMany
    ...
    def has_many_through(
        ...
        from almasix.orm.relations import HasManyThrough
    ...
    def morph_to_many(self, related: type[Model], name: str, table: str | None = None):
        from almasix.orm.relations import MorphToMany
