...
from almasix.encryption.cipher import decrypt_string as _decrypt_string
from almasix.encryption.cipher import encrypt_string as _encrypt_string
...
class Encrypter:
    ...
    def __init__(self, key: str, previous_keys: list[str] | None = None) -> None:
        self.key = key or "almasix-insecure-dev-key-change-me"
