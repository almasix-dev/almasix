...
Almasix has two of them because reading a row is awaited. :class:`LazyCollection`
...
materialise an eager :class:`~almasix.support.collection.Collection` and use its
full surface.
"""
...
from almasix.support.collection import Collection, value_get
